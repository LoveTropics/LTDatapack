execute as @p if score @s scavenger_hunt_count matches 4.. run collectible give @s item minecraft:written_book[minecraft:written_book_content={resolved:1b,author:"The Puzzle Whisperer",pages:[{raw:'{"translate":"lt.scavenger_hunt.clue.05","with":[{"translate":"lt.scavenger_hunt.clue","with":[{"text":"5"},{"translate":"lt.scavenger_hunt.spacer.start"}]},{"translate":"lt.scavenger_hunt.spacer.end"}]}'}],title:{raw:"Clue 05"}}]
