...
execute as @e[tag=golfCrab] if data entity @s {Motion:[0.0,0.0,0.0]} at @s if block ~ ~-1 ~ minecraft:magenta_concrete_powder run tp @e[tag=magentaTele,sort=nearest,limit=1]
execute as @e[tag=golfCrab] if data entity @s {Motion:[0.0,0.0,0.0]} at @s if block ~ ~-1 ~ minecraft:white_concrete_powder run tp @e[tag=whiteTele,sort=nearest,limit=1]
execute as @e[tag=golfCrab] if data entity @s {Motion:[0.0,0.0,0.0]} at @s if block ~ ~-1 ~ minecraft:orange_concrete_powder run tp @e[tag=orangeTele,sort=nearest,limit=1]
execute as @e[tag=golfCrab] if data entity @s {Motion:[0.0,0.0,0.0]} at @s if block ~ ~-1 ~ minecraft:light_blue_concrete_powder run tp @e[tag=lightBlueTele,sort=nearest,limit=1]
execute as @e[tag=golfCrab] if data entity @s {Motion:[0.0,0.0,0.0]} at @s if block ~ ~-1 ~ minecraft:yellow_concrete_powder run tp @e[tag=yellowTele,sort=nearest,limit=1]
