...
# Kills the crab
$execute as @e[tag=hole$(XpLevel)End,current_world=true] at @s run function lt:world_games/minigolf/core/utils/kill_crab {hole:$(XpLevel)}

# Resets The Player
$execute as @p[tag=hole$(XpLevel)Player,current_world=true] at @s run function lt:world_games/minigolf/core/utils/gamemode
