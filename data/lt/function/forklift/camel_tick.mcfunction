...
$execute as @s at @s anchored feet positioned ^ ^ ^5.0 positioned ~ ~2 ~ run execute as @a[tag=forklift_rider,tag=!forklift_rider.$(forklift_id),limit=1,sort=nearest,distance=..3] run damage @s 0.2 minecraft:mace_smash
