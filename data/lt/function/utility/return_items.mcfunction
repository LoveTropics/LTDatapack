...
execute unless data entity @s Inventory[{id:"ltextras:tropical_map"}] run collectible give @s lt:utility/tropical_map
...
execute unless data entity @s Inventory[{id:"ltextras:collectible_basket"}] run collectible give @s lt:utility/collectible_basket
