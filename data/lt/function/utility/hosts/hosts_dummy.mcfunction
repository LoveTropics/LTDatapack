...
execute if score count global.utility matches 2 as @e[tag=host03Marker] at @s run summon dummyplayers:dummy_player ~ ~ ~ {Tags:["dummyHost03", "hostDummy"], Invulnerable:1b, DisabledSlots:4144959}
...
execute as @e[tag=dummyHost01] at @s run tp @s ~ ~ ~ 45 0
