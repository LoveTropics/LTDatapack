...
execute as @e[tag=host_1] run dummyplayer modify @s entity @p[tag=p_host_01]
execute as @e[tag=host_2] run dummyplayer modify @s entity @p[tag=p_host_01]
execute as @e[tag=host_2] run dummyplayer modify @s entity @p[tag=p_host_02]
execute as @e[tag=host_3] run dummyplayer modify @s entity @p[tag=p_host_03]
execute as @e[tag=host_4] run dummyplayer modify @s entity @p[tag=p_host_04]
execute as @e[tag=host_5] run dummyplayer modify @s entity @p[tag=p_host_05]
execute as @e[tag=host_6] run dummyplayer modify @s entity @p[tag=p_host_06]
