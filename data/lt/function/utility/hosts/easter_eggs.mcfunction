...
#Rushmead
execute as @s if data entity @s {ProfileID: [I;-510354127,1335312954,-2111215345,-696947940]} run data modify entity @s HandItems set value [{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-1425014579,-1424734237,-1938822881,-2030827905],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzA2NjIyMmI0M2M0NTE5OGY5ZWNkNzdiYzE0MTI3MmIzOWEyNjlkNjhlNzQ3MTIwODEwNDRkNWY5MzExOTkyMiJ9fX0="}]}}}}]
#RichardThornton
execute as @s if data entity @s {ProfileID: [I;-1017164661,-961199337,-1545933079,568807566]} run data modify entity @s HandItems set value [{id:"minecraft:medium_amethyst_bud",Count:1b},{}]
#8bitelliott
execute as @s if data entity @s {ProfileID: [I;1620193629,2030587671,-1824011384,290968943]} run data modify entity @s HandItems set value [{id:"minecraft:small_amethyst_bud",Count:1b},{}]
#Snifferish
execute as @s if data entity @s {ProfileID: [I;-1876181276,-1409793323,-1488194053,1010518261]} run data modify entity @s HandItems set value [{id:"minecraft:torchflower",Count:1b},{}]
#BadgerSpanner
execute as @s if data entity @s {ProfileID: [I;-679712667,-555859500,-1260001842,482594565]} run data modify entity @s HandItems set value [{id:"create:bar_of_chocolate",Count:1b},{}]
#Syszee
execute as @s if data entity @s {ProfileID: [I;-517872297,-1066122303,-1680966707,1174563393]} run data modify entity @s HandItems set value [{id:"minecraft:structure_block",Count:1b},{}]
#Knarfy
execute as @s if data entity @s {ProfileID: [I;1651221373,-2028256057,-1816515280,595105689]} run data modify entity @s HandItems set value [{id:"minecraft:command_block",Count:1b},{}]
#Bobicraft
execute as @s if data entity @s {ProfileID: [I;571400467,2001030148,-1746918587,-1943922051]} run data modify entity @s HandItems set value [{id:"tropicraft:music_disc_summering",Count:1b},{}]
#NotActuallyTerry
