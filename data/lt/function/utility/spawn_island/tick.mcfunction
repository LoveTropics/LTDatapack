...
execute as @a[scores={spawn_island.time=0},tag=!utility.player.joined,tag=!ltminigames.isolated] run function lt:utility/player/first_join
execute as @a[scores={spawn_island.skip_time=0},tag=!utility.player.joined,tag=!ltminigames.isolated] run function lt:utility/player/first_join