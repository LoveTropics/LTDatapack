...
item replace entity @s weapon.mainhand with tropicraft:exploding_coconut[tropicraft:destroys_blocks=false,tropicraft:explosion_radius=1,ltextras:cooldown_override=50] 64
