...
execute if score Players disguise.cloneing matches 1 run execute as @e[tag=disguises.player.cloned,limit=1] at @s run function lt:diguises/clone/stages/stage_clone with entity @p