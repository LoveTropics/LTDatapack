...
data modify entity @e[tag=diguises.cloned.target,limit=1] collectible.components.ltminigames:disguise.entity.tag set value {}
data modify entity @e[tag=diguises.cloned.target,limit=1] collectible.components.ltminigames:disguise.entity.tag.profile set from entity @e[tag=disguises.data_entity,limit=1] profile
