...
execute if score @s quest.dia.end_state matches 0 run tellraw @s [{"text":"Sensible Sam","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_secretary.cancel","color": "gray"}]
