...
# end_state == 1 | Send message about new collectible
execute if score @s quest.dia.end_state matches 0.. run function lt:quest/data/no_cents_intro/advance_stage with gamedata lt:quest/data/no_cents_intro @s[type=player]
