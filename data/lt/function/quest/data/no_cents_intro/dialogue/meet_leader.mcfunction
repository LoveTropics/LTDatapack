...
## Standard Dialogue
execute if score @s quest.dia.target_line matches 1 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.1","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 2 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.2","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 3 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.3","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 4 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.4","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 5 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.5","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 6 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.6","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 7 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.7","color": "gray"}]
