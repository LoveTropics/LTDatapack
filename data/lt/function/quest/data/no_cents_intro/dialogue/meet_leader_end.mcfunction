...
execute if score @s quest.dia.end_state matches 0 run tellraw @s [{"text":"Count Sense-less","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.meet_leader.cancel","color": "gray"}]
...
execute if score @s quest.dia.end_state matches 1 run function lt:quest/data/no_cents_intro/advance_stage with gamedata lt:quest/data/no_cents_intro @s[type=player]
