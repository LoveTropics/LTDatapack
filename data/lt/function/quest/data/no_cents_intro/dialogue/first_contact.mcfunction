...
## Standard Dialogue
execute if score @s quest.dia.target_line matches 1 run tellraw @s [{"text":"???","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.initial_contact.1","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 2 run tellraw @s [{"text":"???","color":"#2BB6E4"},{"text": ": ","color": "gray"},{"translate": "lt.quest.no_cents_intro.initial_contact.2","color": "gray"}]
