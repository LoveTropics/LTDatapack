...
execute if score @s quest.dia.end_state matches 0 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.cancel","color": "gray"}]
