...
execute if score @s quest.dia.end_state matches 0.. run function lt:quest/data/cents_intro/advance_stage with gamedata lt:quest/data/cents_intro @s[type=player]
