...
## Standard Dialogue
execute if score @s quest.dia.target_line matches 1 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.1","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 2 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.2","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 3 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.3","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 4 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.4","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 5 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.5","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 6 run tellraw @s [{"text":"Jumpy Joe","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.meet_agent.6","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 7 run data modify gamedata lt:quest/active_dialogue @s[type=player] end_state set value 1
