...
## Standard Dialogue
execute if score @s quest.dia.target_line matches 1 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.1","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 2 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.2","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 3 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.3","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 4 run tellraw @s [{"text":"[PA]","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.4","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 5 run tellraw @s [{"text":"[PA]","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.5","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 6 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.6","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 7 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.7","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 8 run tellraw @s [{"text":"[Dan]","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.8","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 9 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.9","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 10 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.10","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 11 run tellraw @s [{"text":"[Dan]","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.11","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 12 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.12","color": "gray"}]
...
execute if score @s quest.dia.target_line matches 13 run tellraw @s [{"text":"Claire","color":"#B24D01"},{"text": ": ","color": "gray"},{"translate": "lt.quest.cents_intro.enter_bunker.13","color": "gray"}]
