...
execute as @e[type=marker,tag=events.in_game.parrot_party.tracker] at @s as @e[tag=events.in_game.parrot_party.parrot] run data modify entity @s Variant set from storage lt:parrot_party Variant
