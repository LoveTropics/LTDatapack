...
execute as @a[tag=hole_2_player] run function lt:game/minigolf/core/golf_leave_message
execute as @a[tag=hole_2_player] run playsound create:scroll_value ambient @s ~ ~ ~ 100 .05
...
# Stops the timer
schedule clear lt:game/minigolf/holes/hole_2/timer
schedule clear lt:game/minigolf/holes/hole_2/timer
