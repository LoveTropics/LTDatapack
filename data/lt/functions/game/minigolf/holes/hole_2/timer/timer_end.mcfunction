execute at @a[tag=hole_2_player] run playsound minecraft:block.note_block.didgeridoo voice @a[tag=hole_2_player] ~ ~ ~ 1 0.1
...
title @a[tag=hole_2_player] actionbar [{"text":"Your time has ran out for the #2 of Crab Golf","color":"red"}]
