...
execute unless score hole09Hits golf.global > hole09HighScores golf.global run give @s ltextras:tropicoin 1
...
execute unless score hole09Hits golf.global > hole09HighScores golf.global run tag @s add hole09HighScored
