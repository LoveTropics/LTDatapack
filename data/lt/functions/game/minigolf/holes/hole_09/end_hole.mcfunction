...
give @a[tag=hole09Player,tag=!hole09Played] ltextras:tropicoin 2
...
execute unless score hole09Hits golf.global > hole09HighScores golf.global run give @a[tag=hole09Player] ltextras:tropicoin 1
execute unless score hole09Hits golf.global > hole09HighScores golf.global run scoreboard players add @a[tag=!hole09HighScored,tag=hole09Player] golf.highscores 1
execute unless score hole09Hits golf.global > hole09HighScores golf.global run tag @a[tag=hole09Player] add hole09HighScored
...
#TropiCoins
tag @a[tag=hole09Player] add hole09Played
execute as @a[tag=hole09Player] run function lt:game/minigolf/core/collectible
#42?
execute as @a[tag=hole09Player] run function lt:game/minigolf/core/42
