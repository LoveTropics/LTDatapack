...
title @p[tag=hole08Player] actionbar [{"text":"Seconds Left: ","color":"dark_gray"},{"score":{"name":"hole08Timer","objective":"golf.global"},"color":"yellow"},{"text":" | "},{"text":"Hits: ","color":"dark_gray"},{"score":{"name":"hole08Hits","objective":"golf.global"},"color":"green"}]
