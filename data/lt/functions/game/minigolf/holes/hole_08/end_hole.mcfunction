...
execute unless score hole08Hits golf.global > hole08HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole08Played] ltextras:tropicoin 2
tag @a add hole08Played
