...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole08Player] run title @p[tag=!hole08Player] actionbar ["",{"selector":"@p[tag=hole08Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
