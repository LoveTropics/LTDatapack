...
execute unless score hole15Hits golf.global > hole15HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole15Played] ltextras:tropicoin 2
tag @a add hole15Played
