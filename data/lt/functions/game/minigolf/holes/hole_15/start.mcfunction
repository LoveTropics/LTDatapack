...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole15Player] run title @p[tag=!hole15Player] actionbar ["",{"selector":"@p[tag=hole15Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
