...
title @p[tag=hole15Player] actionbar [{"text":"Seconds Left: ","color":"dark_gray"},{"score":{"name":"hole15Timer","objective":"golf.global"},"color":"yellow"},{"text":" | "},{"text":"Hits: ","color":"dark_gray"},{"score":{"name":"hole15Hits","objective":"golf.global"},"color":"green"}]
