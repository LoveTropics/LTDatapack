...
execute unless score hole10Hits golf.global > hole10HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole10Played] ltextras:tropicoin 2
tag @a add hole10Played
