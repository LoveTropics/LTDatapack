...
execute at @e[tag=hole_1_start] run summon tropicraft:fiddler_crab ~ ~ ~ {NoGravity:1b,Silent:1b,Health:500f,Tags:["hole_1","golf_crab"],Attributes:[{Name:generic.max_health,Base:500},{Name:generic.knockback_resistance,Base:0.75},{Name:generic.movement_speed,Base:0}]}
team join anticrabcollision @e[tag=golf_crab,tag=hole_1]
function lt:game/minigolf/holes/hole_1/timer/timer_start