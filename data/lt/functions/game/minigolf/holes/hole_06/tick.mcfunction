...
execute as @e[tag=hole06Crab] at @s if block ~ ~-1 ~ minecraft:magenta_concrete_powder run tp @s @e[tag=hole06TeleporterMagenta,limit=1]

##execute as @e[tag=hole06Crab] at @s if block ~ ~ ~ create:honey run data modify entity @s Motion set value [0.0,-0.78400006528789d,0.0]
execute as @e[tag=hole06Crab] at @s if block ~ ~-1 ~ minecraft:blue_concrete_powder run tp @s @e[tag=hole06TeleporterBlue,limit=1]