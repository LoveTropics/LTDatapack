...
execute unless score hole06Hits golf.global > hole06HighScores golf.global run give @s ltextras:tropicoin 1
execute unless score hole06Hits golf.global > hole06HighScores golf.global run scoreboard players add @s[tag=!hole06HighScored] golf.highscores 1
execute unless score hole06Hits golf.global > hole06HighScores golf.global run tag @s add hole06HighScored
