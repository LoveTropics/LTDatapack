...
execute unless score hole06Hits golf.global > hole06HighScores golf.global run scoreboard players add @a[tag=!hole06HighScored,tag=hole06Player] golf.highscores 1
...
#42?
execute as @a[tag=hole06Player] run function lt:game/minigolf/core/42
