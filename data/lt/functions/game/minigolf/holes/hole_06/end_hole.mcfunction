...
execute unless score hole06Hits golf.global > hole06HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole06Played] ltextras:tropicoin 2
tag @a add hole06Played
