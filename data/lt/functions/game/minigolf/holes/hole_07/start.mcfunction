...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole07Player] run title @p[tag=!hole07Player] actionbar ["",{"selector":"@p[tag=hole07Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
