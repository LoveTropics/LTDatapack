...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole16Player] run title @p[tag=!hole16Player] actionbar ["",{"selector":"@p[tag=hole16Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
