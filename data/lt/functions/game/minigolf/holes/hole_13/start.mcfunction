...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole13Player] run title @p[tag=!hole13Player] actionbar ["",{"selector":"@p[tag=hole13Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
