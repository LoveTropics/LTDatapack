...
execute as @a[tag=hole_13_player] run function lt:game/minigolf/core/golf_leave_message
execute as @a[tag=hole_13_player] run playsound create:scroll_value ambient @s ~ ~ ~ 100 .05
