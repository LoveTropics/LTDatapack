...
execute unless score hole13Hits golf.global > hole13HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole13Played] ltextras:tropicoin 2
tag @a add hole13Played
