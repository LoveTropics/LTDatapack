...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole18Player] run title @p[tag=!hole18Player] actionbar ["",{"selector":"@p[tag=hole18Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
