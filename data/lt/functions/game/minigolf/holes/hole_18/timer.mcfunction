...
title @p[tag=hole18Player] actionbar [{"text":"Seconds Left: ","color":"dark_gray"},{"score":{"name":"hole18Timer","objective":"golf.global"},"color":"yellow"},{"text":" | "},{"text":"Hits: ","color":"dark_gray"},{"score":{"name":"hole18Hits","objective":"golf.global"},"color":"green"}]
