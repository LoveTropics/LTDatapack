...
execute unless score hole8hits golfGlobal > hole8highscore golfGlobal as @e[tag=hole_8_dummy] run function lt:game/minigolf/holes/hole_8/dummy
...
tag @a[tag=hole_8_player] remove mini_golf_started
