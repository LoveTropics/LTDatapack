...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole12Player] run title @p[tag=!hole12Player] actionbar ["",{"selector":"@p[tag=hole12Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
