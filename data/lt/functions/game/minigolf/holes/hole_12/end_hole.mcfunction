...
execute unless score hole12Hits golf.global > hole12HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole12Played] ltextras:tropicoin 2
tag @a add hole12Played
