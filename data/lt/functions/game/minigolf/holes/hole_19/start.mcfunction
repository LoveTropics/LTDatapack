...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole19Player] run title @p[tag=!hole19Player] actionbar ["",{"selector":"@p[tag=hole19Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
