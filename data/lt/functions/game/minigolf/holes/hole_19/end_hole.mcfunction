...
execute unless score hole19Hits golf.global > hole19HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole19Played] ltextras:tropicoin 2
tag @a add hole19Played
