...
execute unless score hole20Hits golf.global > hole20HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole20Played] ltextras:tropicoin 2
tag @a add hole20Played
