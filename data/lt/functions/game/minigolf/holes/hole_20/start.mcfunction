...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole20Player] run title @p[tag=!hole20Player] actionbar ["",{"selector":"@p[tag=hole20Player]"},{"text":" Is already on this hole. Please wait your turn.","color":"#ED8754"}]
