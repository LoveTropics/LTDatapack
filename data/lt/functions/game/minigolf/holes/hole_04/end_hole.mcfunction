...
execute unless score hole04Hits golf.global > hole04HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole04Played] ltextras:tropicoin 2
tag @a add hole04Played
