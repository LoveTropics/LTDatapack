...
execute at @e[tag=hole_9_start] run summon tropicraft:fiddler_crab ~ ~ ~ {NoGravity:1b,Silent:1b,Health:500f,Tags:["hole_9","golf_crab"],Attributes:[{Name:generic.max_health,Base:500},{Name:generic.knockback_resistance,Base:0.75},{Name:generic.movement_speed,Base:0}]}
team join anticrabcollision @e[tag=golf_crab,tag=hole_9]
function lt:game/minigolf/holes/hole_9/timer/timer_start