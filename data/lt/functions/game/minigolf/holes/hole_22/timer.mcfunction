...
title @p[tag=hole22Player] actionbar [{"text":"Seconds Left: ","color":"dark_gray"},{"score":{"name":"hole22Timer","objective":"golf.global"},"color":"yellow"},{"text":" | "},{"text":"Hits: ","color":"dark_gray"},{"score":{"name":"hole22Hits","objective":"golf.global"},"color":"green"}]
