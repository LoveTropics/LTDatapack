...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole22Player] run title @p[tag=!hole22Player] actionbar ["",{"selector":"@p[tag=hole22Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
