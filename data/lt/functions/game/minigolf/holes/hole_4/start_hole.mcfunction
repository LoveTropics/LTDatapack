...
scoreboard players set hole4seconds golfGlobal 0
...
execute as @a[tag=hole_4_player,tag=!played_golf] run function lt:game/minigolf/core/first_play
# Summon the crab an tags it
execute at @e[tag=hole_4_start] run function lt:game/minigolf/core/summon_crab
execute at @e[tag=hole_4_start] run tag @e[tag=golf_crab,distance=..5] add hole_4
# Gives the player the putters
function lt:game/minigolf/core/give_putters
# Starts the round of golf
function lt:game/minigolf/holes/hole_4/timer
