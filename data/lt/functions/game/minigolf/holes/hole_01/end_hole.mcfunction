...
execute unless score hole01Hits golf.global > hole01HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole01Played] ltextras:tropicoin 2
tag @a add hole01Played
