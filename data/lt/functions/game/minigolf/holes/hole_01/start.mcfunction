...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole01Player] run title @p[tag=!hole01Player] actionbar ["",{"selector":"@p[tag=hole01Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
