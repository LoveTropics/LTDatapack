...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole21Player] run title @p[tag=!hole21Player] actionbar ["",{"selector":"@p[tag=hole21Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
