...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole17Player] run title @p[tag=!hole17Player] actionbar ["",{"selector":"@p[tag=hole17Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
