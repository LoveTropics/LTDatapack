...
execute unless score hole17Hits golf.global > hole17HighScores golf.global run give @s ltextras:tropicoin 1
execute unless score hole17Hits golf.global > hole17HighScores golf.global run scoreboard players add @s[tag=!hole17HighScored] golf.highscores 1
execute unless score hole17Hits golf.global > hole17HighScores golf.global run tag @s add hole17HighScored
