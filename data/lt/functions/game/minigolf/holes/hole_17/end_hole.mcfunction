...
execute unless score hole17hits golfGlobal > hole17highscore golfGlobal as @e[tag=hole_17_dummy] run function lt:game/minigolf/holes/hole_17/dummy
...
tag @a[tag=hole_17_player] remove mini_golf_started
