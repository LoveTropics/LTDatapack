...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole03Player] run title @p[tag=!hole03Player] actionbar ["",{"selector":"@p[tag=hole03Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
