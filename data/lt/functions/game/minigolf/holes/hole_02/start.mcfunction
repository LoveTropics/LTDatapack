...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole02Player] run title @p[tag=!hole02Player] actionbar ["",{"selector":"@p[tag=hole02Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
