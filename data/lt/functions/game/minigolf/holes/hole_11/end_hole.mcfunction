...
execute unless score hole11Hits golf.global > hole11HighScores golf.global run scoreboard players add @s golf.global 1
...
#TropiCoins
give @s[tag=!hole11Played] ltextras:tropicoin 2
tag @a add hole11Played
