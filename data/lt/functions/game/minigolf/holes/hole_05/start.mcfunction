...
execute if entity @s[tag=!golfInGame] if entity @a[tag=hole05Player] run title @p[tag=!hole05Player] actionbar ["",{"selector":"@p[tag=hole05Player]"},{"translate":"lt.golf.in_use","color":"#ED8754"}]
