...
execute unless score hole05Hits golf.global > hole05HighScores golf.global run scoreboard players add @a[tag=!hole05HighScored,tag=hole05Player] golf.highscores 1
