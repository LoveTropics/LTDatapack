...
# Chest (Color)
item replace entity @s armor.chest with leather_chestplate{display:{Name:'{"translate":"lt.game.qottott.class.acrobat.name","color":"light_purple","italic":false}',color:16082146},HideFlags:255,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],Trim:{material:"minecraft:amethyst",pattern:"minecraft:wayfinder"}} 1

# Weapon
item replace entity @s weapon.mainhand with wooden_sword{display:{Name:'{"translate":"lt.game.qottott.class.glass_cannon.weapon_name","color":"red","italic":false}'},HideFlags:255,Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:1,Operation:0,UUID:[I;-1771193999,-1390129351,-1219003945,197838923],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2.25,Operation:0,UUID:[I;-1782035422,1629704147,-1777711428,-1163549348],Slot:"mainhand"}]} 1
