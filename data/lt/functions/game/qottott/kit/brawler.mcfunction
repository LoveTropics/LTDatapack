...
item replace entity @s weapon.mainhand with stick{HideFlags:255,display:{Name:'{"translate":"lt.game.qottott.class.brawler.weapon_name","color":"#FF7700","italic":false}'},Enchantments:[{id:"minecraft:knockback",lvl:45s}]} 1
