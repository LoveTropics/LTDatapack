...
tag @s remove turtle_race.one_way.player.boost_available
scoreboard players set @s r.o.p_boost_time 500

execute as @e[tag=turtle_race.one_way.entity.turtle,sort=nearest,limit=1,distance=..2] at @s run function lt:game/party/race_one_way/turtle/boost/add
clear @s
