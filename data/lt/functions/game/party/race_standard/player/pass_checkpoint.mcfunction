tag @s add turtle_race.standard.checkpoint_passed
scoreboard players add @s r.s.p_checkpoint 1
title @s actionbar [{"text":"You just passed checkpoint: ","color":"#77A12F"},{"score":{"name":"@s","objective":"r.s.p_checkpoint"},"color":"#166D86"}]
