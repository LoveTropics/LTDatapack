...
tellraw @a[tag=game.party.spleef.player] [{"text":">>> ","color":"gray"},{"text":"Spleef ❯ The third level of the volcano has become unstable. It will now crumble below your feet!","color":"yellow"}]
...
scoreboard players operation time_to_forced_progression s.global = SETTING.FLOOR4_TIME_TO_FP s.global
