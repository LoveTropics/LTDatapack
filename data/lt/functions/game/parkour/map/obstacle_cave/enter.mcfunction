...
execute unless entity @s[gamemode=spectator] run tellraw @s [{"translate":"lt.game.parkour.general.message.entered"},{"translate":"lt.game.parkour.golf.name"},{"translate":"lt.game.parkour.general.message.parkour_course"}]
...
execute unless entity @s[gamemode=spectator] run tag @s add parkour.obstacle_cave
...
execute unless entity @s[gamemode=spectator] run scoreboard players operation @s parkour.checkpoint = @s parkour.obstacle_cave.checkpoint_last
