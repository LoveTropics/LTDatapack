...
execute if score all donations.totals matches 20000.. as @a[current_world=true,tag=!collectibles.granted-four] run function lt:lt:events/milestone/grant/twenty_turtle
execute if score all donations.totals matches 25000.. as @a[current_world=true,tag=!collectibles.granted-five] run function lt:lt:events/milestone/grant/twenty-five_col_cojo
