...
#Philza Online Unlock 84555089-add1-49b1-a26d-8021270a40f0
execute as ae9c317a-cf2e-43c5-9b32-37a6ae83879f at @s if dimension tropicraft:tropics run execute as @a[current_world=true,tag=!collectibles.tranted-ph1zla] run function lt:events/milestone/grant/philza
