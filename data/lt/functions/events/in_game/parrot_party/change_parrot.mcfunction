...
execute as @e[tag=events.in_game.parrot_party.parrot_spawn,sort=random,limit=1] run data modify entity @s Variant set from storage lt:parrot_party Variant
