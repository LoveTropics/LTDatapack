...
execute if score count global.utility matches 1.. as @e[tag=host01Marker] at @s run summon dummyplayers:dummy_player ~ ~ ~ {Tags:["dummyHost01", "hostDummy"], Invulnerable:1b}
execute if score count global.utility matches 2.. as @e[tag=host02Marker] at @s run summon dummyplayers:dummy_player ~ ~ ~ {Tags:["dummyHost02", "hostDummy"], Invulnerable:1b}
execute if score count global.utility matches 3.. as @e[tag=host03Marker] at @s run summon dummyplayers:dummy_player ~ ~ ~ {Tags:["dummyHost03", "hostDummy"], Invulnerable:1b}
