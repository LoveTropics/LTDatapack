...
#slicedlime
execute as @s if data entity @s {ProfileID: [I;-1674917544,1575568808,-1935589086,-347337826]} run data modify entity @s HandItems set value [{id:"tropicraft:limeade",Count:1b},{}]
#millkberry
