...
#slicedlime
execute if data entity @s {ProfileID: [I;-1674917544,1575568808,-1935589086,-347337826]} run data modify entity @s HandItems set value [{id:"tropicraft:limeade",Count:1b},{}]
#millkberry
execute if data entity @s {ProfileID: [I;1516136082,-1512355275,-1273681262,1206684784]} run data modify entity @s HandItems set value [{id:"minecraft:experience_bottle",Count:1b},{}]
#MacNcheeseP1z
execute if data entity @s {ProfileID: [I;-870806706,-438285351,-1812630518,-977540790]} run data modify entity @s HandItems set value [{id:"minecraft:writable_book",Count:1b},{}]
#PearlescentMoon
execute if data entity @s {ProfileID: [I;1976066990,-1148041107,-1860414717,206908384]} run data modify entity @s HandItems set value [{id:"minecraft:large_amethyst_bud",Count:1b},{}]
#Talon_MC
execute if data entity @s {ProfileID: [I;42250248,-361936331,-1457856371,915838635]} run data modify entity @s HandItems set value [{id:"minecraft:diamond",Count:1b},{}]
#Pixlriffs
execute if data entity @s {ProfileID: [I;1985151379,-516600059,-1885570566,683693240]} run data modify entity @s HandItems set value [{id:"minecraft:redstone_torch",Count:1b},{}]
#joehillssays
execute if data entity @s {ProfileID: [I;1404757078,-608482257,-1938186610,-1033075838]} run data modify entity @s HandItems set value [{id:"tropicraft:large_bongo_drum",Count:1b},{}]