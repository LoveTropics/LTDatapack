...
title @s[tag=colorblind] actionbar [{"translate":"lt.info.colorblind.on", "color": "white"}]
title @s[tag=!colorblind] actionbar [{"translate":"lt.info.colorblind.off", "color": "white"}]
