collectible clear @s ltminigames:disguise{donation_goal:true,disguise:{entity:{type:"minecraft:frog"}}}
collectible clear @s ltminigames:disguise{donation_goal:true,disguise:{entity:{type:"tropicraft:tropicreeper"}}}
collectible clear @s ltminigames:disguise{donation_goal:true,disguise:{entity:{type:"minecraft:bat"}}}
collectible clear @s ltminigames:disguise{donation_goal:true,disguise:{entity:{type:"minecraft:fox"}}}
