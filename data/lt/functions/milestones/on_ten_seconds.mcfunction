...
execute if entity 84555089-add1-49b1-a26d-8021270a40f0 if dimension tropicraft:tropics run @a[current_world=true,tag=!collectibles.tranted-ph1zla] run function lt:milestones/grant/ph1zla
